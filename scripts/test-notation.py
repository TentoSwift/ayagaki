...
FIXTURES = {
  ...
  # 左半面の⬆・上ルは中央の色の1段後に出る（ユーザー確認 2026-07-07）
  "中央⬆はそれぞれ2段先で③で戻す": ([[],[],[],[],[],[],[]], [2,3,4], [1,2,3],
    ["ナミ","ナミ","ナミ⬆","ナミ⬆","③ナミ⬆","③ナミ","③ナミ"]),
  "中央⬆と模様の混在": ([[],[1],[],[1],[],[]], [2,3,4], [1,2,3],
